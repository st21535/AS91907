...
class TaskManger:
    def __init__(self, parent):
        ...
        # Submit button
        self.name_button = Button(self.frame, text="Submit", font="Arial 16", command=self.submit)
        self.name_button.grid(padx=10, pady=10, row=13)

    def submit(self):

        #Ensuring valid Date Input
        try:
        ...
        task_information = {"Project Name": project_name, "Level": str(self.levels[self.radio_var.get()]),"Due Date": due_date,"Progress": 0}
        data.append(task_information)
